...
class paddle {
  ...
  Paddle(integer _x, integer _y, String _image, char _upKey, char _downKey) 
    x = _x;
    y = _y;
    vx = 0;
    vy = 0;
    
    image = loadImageFromFile(_image);
  ...
  void update() {
    ...
    y = constraint(y,0 + image.height/2,height - image.height/2);
  }
